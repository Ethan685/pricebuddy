 ...
 */
export class YahooJapanAdapter extends BaseMerchantAdapter {
    readonly name = 'Yahoo Japan';
    readonly region: Region = 'JP';
 ...
 * Amazon JP Adapter
 */
export class AmazonJPAdapter extends BaseMerchantAdapter {
    readonly name = 'Amazon JP';
    readonly region: Region = 'JP';
    readonly currency = 'JPY';
    readonly countryCode = 'JP';
 ...
 */
export class MercariJPAdapter extends BaseMerchantAdapter {
    readonly name = 'Mercari JP';
    readonly region: Region = 'JP';
    readonly currency = 'JPY';
    readonly countryCode = 'JP';
 ...
 * Qoo10 JP Adapter
 */
export class Qoo10JPAdapter extends BaseMerchantAdapter {
    readonly name = 'Qoo10 JP';
    readonly region: Region = 'JP';
    readonly currency = 'JPY';
    readonly countryCode = 'JP';
