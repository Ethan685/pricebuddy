export class ViralShare {
     ...
     */
    static generateShareLink(baseUrl: string, path: string, referralCode?: string): string {
     ...
     */
    static generateProductMeta(product: { title: string; description?: string; image?: string }) {
        return {
