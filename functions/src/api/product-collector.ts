...
function getDemoProducts(category: string, limit: number): any[] {
    ...
    const allProducts = [
        { title: "삼성 갤럭시 S24 Ultra", price: 1390000, marketplace: "coupang", imageUrl: "/img/product-placeholder.svg" },
        { title: "삼성 갤럭시 S24", price: 999000, marketplace: "coupang", imageUrl: "/img/product-placeholder.svg" },
        { title: "갤럭시 Z 플립5", price: 1290000, marketplace: "naver", imageUrl: "/img/product-placeholder.svg" },
        { title: "LG 그램 17인치 노트북", price: 1890000, marketplace: "coupang", imageUrl: "/img/product-placeholder.svg" },
        { title: "맥북 프로 16인치 M3", price: 3290000, marketplace: "naver", imageUrl: "/img/product-placeholder.svg" },
        { title: "맥북 에어 15인치 M3", price: 1990000, marketplace: "coupang", imageUrl: "/img/product-placeholder.svg" },
        { title: "에어팟 프로 2세대", price: 390000, marketplace: "coupang", imageUrl: "/img/product-placeholder.svg" },
        { title: "갤럭시 버즈2 프로", price: 199000, marketplace: "naver", imageUrl: "/img/product-placeholder.svg" },
        { title: "소니 WH-1000XM5 헤드폰", price: 499000, marketplace: "coupang", imageUrl: "/img/product-placeholder.svg" },
        { title: "아이패드 프로 12.9인치", price: 1290000, marketplace: "naver", imageUrl: "/img/product-placeholder.svg" },
        { title: "갤럭시 워치6 클래식", price: 399000, marketplace: "coupang", imageUrl: "/img/product-placeholder.svg" },
        { title: "플레이스테이션 5", price: 699000, marketplace: "naver", imageUrl: "/img/product-placeholder.svg" },
    ];
